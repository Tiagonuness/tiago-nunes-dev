          ...
          <div className="flex flex-col sm:flex-row gap-4 items-center">
            <div>
              ...
              <div className="flex gap-4 flex-wrap justify-center w-full md:w-max mt-4">
                <Button size="lg" className="group transition-all duration-300 hover:scale-105 bg-gradient-to-b dark:from-blue-300 dark:to-blue-500 text-white" onClick={contato} asChild>
